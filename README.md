...
## Algorithm
1. Import the required libraries and create the employee salary dataset using a pandas DataFrame.

2. Split the dataset into feature (Level) and target variable (Salary).

3. Train the Decision Tree Regressor model using the Level feature to learn the salary pattern.

4. Predict salaries for existing and new employee levels and visualize the results using a regression plot.
